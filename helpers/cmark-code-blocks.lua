...
-- 
-- That's what cmark and pretty much every other CommonMark implementation does
-- Pandoc, however, outputs <code class="somelang">
--
-- This makes using external highlighter much more difficult
...
-- to a produce CommonMark-style output.
